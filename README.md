## Parte I y II Proyecto Espacio Digital y Elecciones
...
Para esto, se definen las siguientes variables -> Variable Independiente: gasto partidario en campañas de publicidad digital; Variable Dependiente: resultados electorales; Variables Intervinientes: evolución temporal, tipo de elección, orientación política del partido, entre otras a identificar.
A su vez, se definen 3 principales ejes de análisis -> Análisis de correlación y/o regresión gasto espacio digital - resultados electorales; Análisis de progresión anual del gasto en espacio digital por partido; Análisis complementario de variables intervinientes y "espacios vacíos".
Por unidad principal de análisis se tendrán a algunos Partidos Políticos seleccionados
